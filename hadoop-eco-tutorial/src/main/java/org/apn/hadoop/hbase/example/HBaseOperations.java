package org.apn.hadoop.hbase.example;
...
public class HBaseOperations {
	public static void main(String args[]) {
		...
		try {
			...
			/**
			 * Check for "employee" table existence in HBase If the table is not
			 * present in HBase it creates table with personal, professional
			 * column families
			 * 
			...
			if (!admin.isTableAvailable(TableName.valueOf(tableName))) {
				...
				/**
				 * Read data in "employee" table in two different ways: 1.
				 * Reading by using row key 2. Reading entire table using
				 * ResultScanner
				 */
